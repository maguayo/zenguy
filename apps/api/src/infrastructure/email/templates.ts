...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f8fafc" style="width:100%;margin:22px 0 0;background:#f8fafc;border:1px solid #e4e4e7;border-radius:8px">
  <tr><td style="padding:18px 20px 8px;color:#52525b;font-family:'Courier New',Courier,monospace;font-size:10px;font-weight:700;letter-spacing:1.2px">YOUR LAUNCH PLAN</td></tr>
...
<p style="margin:18px 0 0;padding:12px 14px;background:#eef2ff;border-left:3px solid #4f46e5;border-radius:4px;color:#3730a3;font-size:13px;line-height:20px"><strong>No card required.</strong> Your complete Zenguy plan is free during launch.</p>`;
  ...
  const text = [
    ...
    "",
    "No card required. Your complete Zenguy plan is free during launch.",
    "",
    "Verify my email:",
    verifyUrl,
    "",
