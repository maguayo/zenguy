/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9058789ee0b497a789e0a6d96b70a594)
...
interface __BaseEnv_Env {
	...
	APP_URL: "https://staging-app.zenguy.com" | "https://app.zenguy.com" | "http://localhost:5173";
	...
	RUNNER_ENVIRONMENT?: "staging" | "production";
	PUBLIC_API_URL?: "https://staging-app.zenguy.com" | "https://app.zenguy.com";
	JWT_SECRET: string;
	...
	RUNNER_FALLBACK_API_TOKEN: string;
	...
	KEY_WRAPPING?: Service /* entrypoint KeyWrappingService from zenguy-kms-staging */ | Service /* entrypoint KeyWrappingService from zenguy-kms-production */;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RunnerContainer";
	}
	interface StagingEnv {
		...
		RUNNER_CF_ACCESS_CLIENT_SECRET: string;
		RUNNER_CONTAINER: DurableObjectNamespace<import("./src/index").RunnerContainer>;
		KEY_WRAPPING: Service /* entrypoint KeyWrappingService from zenguy-kms-staging */;
	}
	interface ProductionEnv {
		...
		RUNNER_CF_ACCESS_COMMON_NAME: string;
		RUNNER_CONTAINER: DurableObjectNamespace<import("./src/index").RunnerContainer>;
		KEY_WRAPPING: Service /* entrypoint KeyWrappingService from zenguy-kms-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_URL" | "CF_ACCESS_TEAM_DOMAIN" | "ENCRYPTION_KEY_ID" | "KEY_WRAPPING_KEY_ID" | "LLM_MODEL" | "STRIPE_ENVIRONMENT" | "EMAIL_FROM" | "COMPLIMENTARY_ISSUER_EMAILS" | "RUNNER_DISPATCH" | "RUNNER_ENVIRONMENT" | "PUBLIC_API_URL" | "JWT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_OAUTH_STATE_SECRET" | "ENCRYPTION_KEY" | "ARTIFACT_URL_SECRET" | "RUNNER_API_TOKEN" | "RUNNER_FALLBACK_API_TOKEN" | "RUNNER_CAPABILITY_SECRET" | "TWILIO_ACCOUNT_SID" | "TWILIO_AUTH_TOKEN" | "TWILIO_FROM_SMS" | "TWILIO_FROM_CALL" | "TWILIO_FROM_WHATSAPP" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRODUCT_ID" | "STRIPE_PRICE_ID" | "STRIPE_OVERAGE_PRICE_ID" | "STRIPE_ALERT_CREDIT_PRODUCT_ID" | "STRIPE_ALERT_CREDIT_PRICE_ID" | "EXPO_PUSH_ACCESS_TOKEN" | "CF_ACCESS_AUD" | "RUNNER_CF_API_TOKEN" | "OPENAI_API_KEY_CF" | "RUNNER_CF_ACCESS_CLIENT_ID" | "RUNNER_CF_ACCESS_CLIENT_SECRET" | "CF_SAAS_ZONE_ID" | "STATUS_CNAME_TARGET" | "RUNNER_UNRESTRICTED_ACTIONS" | "CF_RUNNER_ACCESS_AUD" | "RUNNER_CF_ACCESS_COMMON_NAME">> {}
}
